...
<?php 
	...
	//TÍTULO:
		...
		function carrossel_depoimento($colunas_bootstrap){
			...
			$depoimentos = array(	
									...
									'pessoa_4' => array(	
														...
														'cidade' => 'São Gonçalo',
														'depoimento' =>  'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aperiam, corporis. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Lorem ipsum dolor sit amet, consectetur adipisicing elit.', 	
				  ...
				  <div class='carousel-inner' role='listbox'>
				    <div class='item active'>
						...
						<div class='conteudo-flex'>
							...
							<p class='depoimento  text-center'>
								$depoimento
							</p>
							<div class='pessoa'>
								...
								<div class = 'dados'>			
									...
									<div class='nome'><p class=''><span>$nome</span><br>$cidade</p></div>
									</div>
...
.depoimento .carousel-control .glyphicon-chevron-left, .depoimento .carousel-control .glyphicon-chevron-right, .depoimento .carousel-control .icon-next, .depoimento .carousel-control .icon-prev{
	position:static;
}



.depoimento .carousel-control, .depoimento .carousel-control .glyphicon-chevron-left, .depoimento .carousel-control .glyphicon-chevron-right{
	position: static;
}

.depoimento .carousel-control.right, .depoimento .carousel-control.left {
    background-image: none;
 }


 @media all and (max-width: 500px) {
	.depoimento .conteudo-flex{
...
.depoimento .carousel-control .glyphicon-chevron-left, .carousel-control .icon-prev{
	margin: 0;
}

.depoimento .carousel-control .glyphicon-chevron-right, .carousel-control .icon-next{
	margin:0;
}
